      ...
      <div className="mx-auto grid max-w-[1600px] gap-16 lg:grid-cols-12 items-start">
        <div className="lg:col-span-5 flex flex-col justify-center relative">
          <div className="mb-8 flex items-center gap-4">
            ...
            <div>
              <span className="block font-sans text-xs font-bold uppercase tracking-[0.2em] text-gray-400">Expert's Note</span>
          ...
          <h2 className="font-serif text-4xl leading-tight lg:text-5xl lg:leading-[1.15] mb-8 text-charcoal">
            Cyklinuję bez kurzu - nie musisz po mnie sprzątać.
          </h2>
          <div className="relative pl-6 lg:pl-8 border-l-2 border-wood/50">
            <p className="font-sans text-lg lg:text-xl text-gray-600 font-light italic leading-relaxed">
              "Standardowe cyklinowanie = kurz wszędzie... Cyklinuję, Ty nie sprzątasz."
            </p>
          </div>
        ...
        <div className="lg:col-span-6 lg:col-start-7 flex flex-col justify-center h-full pt-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-16">
            <div className="group flex gap-5 items-start">
              ...
              <div>
                <h3 className="font-bold text-xl mb-2 group-hover:text-wood transition-colors">Bezpyłowo naprawdę</h3>
                <p className="text-sm text-gray-500 leading-relaxed font-light">
                  Systemy odsysania pyłu, które stosuję, są tak skuteczne, że po pracy nie ma śladu pyłu na półkach.
                </p>
              </div>
            </div>
            <div className="group flex gap-5 items-start">
              <div className="shrink-0 flex items-center justify-center w-12 h-12 rounded-full bg-paper group-hover:bg-wood/10 transition-colors duration-500">
                <span className="material-symbols-outlined text-3xl text-wood font-light">texture</span>
              </div>
              <div>
                <h3 className="font-bold text-xl mb-2 group-hover:text-wood transition-colors">Stare parkiety to moja specjalność</h3>
                <p className="text-sm text-gray-500 leading-relaxed font-light">
                  Tam, gdzie inni widzą drewno do zerwania, ja widzę duszę i historię do uratowania.
                </p>
              </div>
            </div>
            <div className="group flex gap-5 items-start">
              <div className="shrink-0 flex items-center justify-center w-12 h-12 rounded-full bg-paper group-hover:bg-wood/10 transition-colors duration-500">
                <span className="material-symbols-outlined text-3xl text-wood font-light">handyman</span>
              </div>
              <div>
                <h3 className="font-bold text-xl mb-2 group-hover:text-wood transition-colors">Wiem co robię z drewnem</h3>
                <p className="text-sm text-gray-500 leading-relaxed font-light">
                  Drewno to żywy materiał. Dobieram chemię i technikę szlifowania indywidualnie do każdej deski.
                </p>
              </div>
            </div>
            <div className="group flex gap-5 items-start">
              ...
              <div>
                <h3 className="font-bold text-xl mb-2 group-hover:text-wood transition-colors">Naprawiam po innych firmach</h3>
                <p className="text-sm text-gray-500 leading-relaxed font-light">
                  Źle wycyklinowana podłoga to nie koniec świata. Poprawiam błędy, góry, doliny i smugi.
                </p>
              </div>
            </div>
          </div>
